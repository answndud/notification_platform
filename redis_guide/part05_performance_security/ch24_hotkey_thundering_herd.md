...
핵심 해석:
- HotKey는 "집중" 문제, Herd는 "동시성" 문제입니다.
- TTL 지터와 요청 병합은 Herd 완화의 기본 안전장치입니다.
...
- HotKey와 Herd를 지표로 어떻게 구분할지 설명할 수 있는가?
- 모든 키 TTL을 동일하게 두면 왜 위험한지 말할 수 있는가?
