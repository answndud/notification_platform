...
- 검증 완료 챕터: `ch01`~`ch10`, `ch12`, `ch13`, `ch14`, `ch16`, `ch17`, `ch20`, `ch23`, `ch24`, `ch25`
- 보류 챕터: `ch11`, `ch13`, `ch15`, `ch18`, `ch19`, `ch21`, `ch22`, `ch25`~`ch30` (멀티 브로커/보안/통합 시나리오 필요)
...
- [ ] 초보자도 이해 가능한 학습 목표 제시
- [ ] CLI 예제 1개 이상 + 실무 시나리오 1개 이상 포함
- [ ] 자주 하는 실수/반례 섹션 포함
- [ ] 요약/연습문제 포함
- [ ] 용어 일관성 및 한국어 문장 교정 완료
